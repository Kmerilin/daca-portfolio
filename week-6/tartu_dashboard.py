...
# Streamlit Cloud: Secrets on kättesaadavad st.secrets kaudu, mitte
# automaatselt os.environ-is. data_loader loob Supabase kliendi
# os.getenv() abil kohe importimise hetkel, seega kopeerime väärtused
# üle enne data_loader importi (lokaalselt .env juba täidab need,
# nii et see ei lähe kohaliku käivitamisega vastuollu).
...
# KPI-kaardid PNG-eksport on eemaldatud: kaleido/Chrome kombinatsioon
# põhjustas Streamlit Cloud konteineris segmentation fault'i. Dashboard'i
# põhifunktsioon (andmelugu + interaktiivsed graafikud) töötab ilma selleta
# täiel määral edasi.
