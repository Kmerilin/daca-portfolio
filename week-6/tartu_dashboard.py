...
_WEEK5_DASHBOARD = (
    ...
    / "week-5" / "urbanstyle-dashboard" / "dashboard"
)
load_dotenv(_WEEK5_DASHBOARD.parent / ".env")
sys.path.insert(0, str(_WEEK5_DASHBOARD))

# Lisame kohaliku dashboard/ kausta importteele (theme.py jaoks).
